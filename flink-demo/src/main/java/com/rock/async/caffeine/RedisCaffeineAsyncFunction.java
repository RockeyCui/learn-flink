 ...
 * @date 2019/8/16
 */
public class RedisCaffeineAsyncFunction extends RichAsyncFunction<Row, Row> {
    ...
    public void asyncInvoke(Row input, ResultFuture<Row> resultFuture) {
        ...
        if (get == null) {
            ...
            get.thenAccept(value -> {
                resultFuture.complete(Collections.singleton(joinData(input, String.valueOf(value))));
            });
        }
    }
